    ...
    >
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
          ...
          <div className="space-y-5 md:col-span-5">
            ...
            <p className="max-w-sm text-sm font-light leading-relaxed text-neutral-500">
              Private Business Asset Marketplace™ para explorar, evaluar y
              solicitar disponibilidad de activos de software empresarial.
            </p>
          ...
          <FooterColumn
            ...
            links={[
              ...
              { label: "Project ZIP™", to: "/pricing#project-zip-section" },
          ...
          <FooterColumn
            ...
            links={[
              ...
              { label: "Licensing", to: "/faq#licensing" },
        ...
        <div className="mt-14 flex flex-col gap-4 border-t border-neutral-200 pt-6 text-[10px] font-medium uppercase tracking-wider text-neutral-400 md:flex-row md:items-center md:justify-between">
          <p>© {year} ProjectApps™. Todos los derechos reservados.</p>
