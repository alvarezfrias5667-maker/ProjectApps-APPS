...
export default function SolutionMatchPage() {
  ...
  const handleSaveEvaluation = () => {
    ...
    const evaluationPayload: SavedEvaluation = {
    ...
    try {
      ...
      const currentEvals: SavedEvaluation[] = currentEvalsJSON
        ? JSON.parse(currentEvalsJSON)
        : [];

      localStorage.setItem(
        "savedEvaluations",
        JSON.stringify([evaluationPayload, ...currentEvals])
      );

      setSaveStatus(true);
    } catch {
      localStorage.setItem("savedEvaluations", JSON.stringify([evaluationPayload]));
      setSaveStatus(true);
    }
  };
